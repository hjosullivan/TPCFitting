...
aux_parameters = ['FinalID', 'OriginalID', 'Citation', 'Latitude', 'Longitude', 'ConKingdom', 'ConPhylum', 'ConClass',
                  'ConOrder', 'ConFamily', 'ConGenus', 'ConSpecies', 'OptimalConditions', 'ConLabGrowthTemp'] 
...
output_data = compile_models(all_models, show_estimates=False, aux_cols = aux_parameters) #Save the summary
